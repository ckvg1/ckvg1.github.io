...
if(local === "ciemny-motyw"){
  document.querySelectorAll("body, header, .modal-content, .hamburger, .tab-button, .oaerror, strong, section, .przycisk, input, select, .icons_div, .bar1, .bar2, .bar3, .nazwaBiura, .temperatura").forEach((el) => {
